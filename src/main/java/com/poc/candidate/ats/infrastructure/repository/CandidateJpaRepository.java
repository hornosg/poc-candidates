package com.poc.candidate.ats.infrastructure.repository;
...
@Repository
public interface CandidateJpaRepository extends JpaRepository<Candidate, Long>, JpaSpecificationExecutor<Candidate>, CandidateRepository {
